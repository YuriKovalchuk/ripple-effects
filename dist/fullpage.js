        ...
        if (
          ...
          if (
            ...
            Math.abs(touchStartX - touchEndX) >
              (window.innerWidth / 100) * options.touchSensitivity
          ) {
    ...
    function addTouchHandler() {
      if (isTouchDevice || isTouch) {
        ...
        if (wrapper) {
          ...
          wrapper.removeEventListener(events.touchmove, touchMoveHandler, {
            passive: false
          });

          wrapper.addEventListener(events.touchstart, touchStartHandler);
          wrapper.addEventListener(events.touchmove, touchMoveHandler, {
            passive: false
          });
        }
      }
