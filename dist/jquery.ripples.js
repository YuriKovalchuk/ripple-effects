...
(function(global, factory) {
  ...
  Ripples.prototype = {
    ...
    initShaders: function() {
      ...
      this.dropProgram = createProgram(
        ...
        [
          ...
          "float drop = max(0.0, 1.0 - length(center.x * 0.5 + 0.5 - coord.x) / (radius*0.8));",
    ...
    dropAtPointer: function(pointer, radius, strength) {
      ...
      for (var i = 0; i < gl.canvas.width / 2; i += 50) {
        this.drop(
          i - this.$el.offset().left - borderLeft,
          i - this.$el.offset().top - borderTop,
          radius,
          strength
        );
      }
